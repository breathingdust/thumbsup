...
// AggregatedIssueReactionResult : Simple DTO
...
// GraphQLClient : Client repository which using the Github GraphQL API
type GraphQLClient struct {
}

// GetAggregatedIssueReactions : For each open GitHub issue returns a count of its and all its referenced issue reactions.
